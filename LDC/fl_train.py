...
def main():
    ...
    train_dataset = RetinopathyDatasetTrain(csv_file='../dataset/ISIC_2018/train.csv', transform=transform_train, test=args.celoss)
    train_loader = torch.utils.data.DataLoader(train_dataset, batch_size=batch_size, shuffle=True, num_workers=4)

    val_dataset = RetinopathyDatasetTrain(csv_file='../dataset/ISIC_2018/test.csv', transform=transform_test, test=True)
    ...
    for i in range(args.clients):
        c_train_dataset = RetinopathyDatasetTrain(csv_file='../dataset/ISIC_2018/train.csv', transform=transform_train, split=(i, args.clients), test=args.celoss)
